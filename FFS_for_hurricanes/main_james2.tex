...
of that seed in the FFS ensemble; pathways from seeds that breached each interface
rarely are weighted accordingly.
...
The model was architected as a strict state-in/state-out emulator: each 6-hour step
