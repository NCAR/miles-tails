...
over the same 98 initial conditions reaches the minimum MSLP threshold in 25.4\% of
members on average;
...
The seasonal evolution of each individual conditional probability $P_i$
(Fig.~\ref{fig:interface_probs}) shows that $P_1$ varies most strongly with the seasonal
cycle, while $P_4$ is the most uniformly suppressed across all ICs.
