...
environment. This conditional framing --- analogous to a conditional return period
given present climate state \citep{finkel2023revealing,finkel2024bringing} --- motivates
...
A more rigorous test --- verifying that $P(B|\lambda_i)$ depends only on the current
state and not on SST or other omitted variables --- is deferred to future work.
...
The central self-consistency result --- FFS and direct-sampling rates agreeing within
$1.03\pm0.15$ across 98 initial conditions --- confirms the correct implementation of
the conditional probability factorization. These estimates use separate components of
...
We thank colleagues at NCAR's Earth System Data Science group for discussions
