...
\caption{FFS shooting trees for the three case-study ICs on a common spherical map.
Each star marks one $\lambda_0$ seed; branches show the cascade of interface crossings
to $\lambda_4$.
\textcolor{blue}{Blue}: Earl IC (2022-09-02T00Z) — seed near 31$^\circ$N, 72$^\circ$W;
trajectories fan northeastward into the open Atlantic.
\textcolor{green!60!black}{Green}: Fiona precursor IC (2022-09-09T12Z) — seed near 19$^\circ$N,
63$^\circ$W; trajectories track northwestward consistent with Fiona's subsequent path.
\textcolor{red}{Red}: Ian precursor IC (2022-09-22T00Z) — seed near 18$^\circ$N,
