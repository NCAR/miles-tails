...
\midrule
MSLP (Pa) & control $[1,1,1]$ & 255.6 & 228.4 & 0.89 & 178.0 \\
 & $\beta_1$ elim.\ $[0,1,1]$ & 250.4 & 207.8 & 0.83 & 175.0 \\
 & $\beta_2$ elim.\ $[1,0,1]$ & 281.0 & 147.0 & 0.52 & 223.3 \\
 & $\beta_3$ elim.\ $[1,1,0]$ & 249.8 & 226.7 & 0.91 & 172.0 \\
\midrule
Z500 (m) & control $[1,1,1]$ & 490.2 & 216.1 & 0.44 & 438.7 \\
 & $\beta_1$ elim.\ $[0,1,1]$ & 484.9 & 200.8 & 0.41 & 435.3 \\
 & $\beta_2$ elim.\ $[1,0,1]$ & 494.4 & 143.4 & 0.29 & 456.7 \\
 & $\beta_3$ elim.\ $[1,1,0]$ & 485.6 & 215.4 & 0.44 & 434.5 \\
\midrule
T850 (K) & control $[1,1,1]$ & 1.260 & 0.973 & 0.77 & 0.921 \\
 & $\beta_1$ elim.\ $[0,1,1]$ & 1.239 & 0.906 & 0.73 & 0.906 \\
 & $\beta_2$ elim.\ $[1,0,1]$ & 1.344 & 0.673 & 0.50 & 1.085 \\
 & $\beta_3$ elim.\ $[1,1,0]$ & 1.234 & 0.962 & 0.78 & 0.888 \\
\bottomrule
\end{tabular}
\caption{Single-scale elimination at T+108\,h for the Winter Storm Izzy case (2022-01-13 00Z initialization): ensemble-mean RMSE, ensemble spread, spread-skill ratio, and CRPS from 20-member ensembles in which one injection point's gain is set to zero at inference while independent noise is drawn at the remaining sites. Eliminating the Level-2 (meso-$\alpha$) site roughly halves SSR and degrades RMSE and CRPS in every field, while eliminating Level~1 or Level~3 leaves spread and skill within roughly 10\% of the control. Inference-time elimination on a single case, not a retrained ablation.}
