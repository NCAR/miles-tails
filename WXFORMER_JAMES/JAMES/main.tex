...
\item Compact latent storage enables perfect forecast reproducibility and post-inference spread adjustment without regenerating members
\item Multi-scale perturbation structure enables operational control over uncertainty: post-inference spread adjustment, ensemble member interpolation, and scale-targeted perturbations
\end{itemize}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{latent_scaling_big_study_anomoly.png}
